...
AutocompleteLocation.prototype.route = function () {
  ...
  this.directionsService.route({
    ...
    if (status === 'OK') {
      ...
      distance.innerHTML = `Distanta dintre  ${directionsData.start_address} si ${directionsData.end_address} este de ${directionsData.distance.text}`;
...
const plasareComanda = () => {
  let comanda = document.getElementById('comanda');
  comanda.innerHTML = "<h4>Comanda efectuata cu succes!</h4>"
}